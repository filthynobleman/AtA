...
TaskTree SimulateExecution(Matrix* Matrix_A, Matrix* Matrix_C, size_t NumProcs, double alpha)
{
	...
	while (q.QSize > 0)
	{
		...
		if (t.Type == ATA)
		{
			...
			{
				// step 1 C21 = A12^T * A11
				SubMatrix A12 = { t.A.M, t.A.BegRow, t.A.BegCol + M2, N2, t.A.NumCols - M2 };
				SubMatrix A11 = { t.A.M, t.A.BegRow, t.A.BegCol, N2, M2 };
				SubMatrix C21 = { t.C.M, t.C.BegRow + M2, t.C.BegCol, t.A.NumCols - M2, M2 };
				Task st1 = { ATB, A12, A11, C21, AtBProcs / 2, t.ID };
				QueueEnqueue(&q, &st1);
				TaskTreeAddTask(&Tree, st1, t.ID);

				// step 2 C21 = A22^T * A21
				SubMatrix A22 = { t.A.M, t.A.BegRow + N2, t.A.BegCol + M2, t.A.NumRows - N2, t.A.NumCols - M2 };
				SubMatrix A21 = { t.A.M, t.A.BegRow + N2, t.A.BegCol, t.A.NumRows - N2, M2 };
				Task st2 = { ATB, A22, A21, C21, AtBProcs - AtBProcs / 2, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
			}
			...
			if (AtAProcs == 1)
			{
				...
				SubMatrix Ax1 = { t.A.M, t.A.BegRow, t.A.BegCol, t.A.NumRows, M2 };
				SubMatrix C11 = { t.C.M, t.C.BegRow, t.C.BegCol, M2, M2 };
				Task st1 = { ATA, Ax1, Ax1, C11, AtAProcs, OtherID };
				QueueEnqueue(&q, &st1);
				...
				Task st2 = { ATA, Ax2, Ax2, C22, AtAProcs, OtherID };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
			}
			else if (AtAProcs == 2)
			...
			{
				size_t Procs11 = AtAProcs / 4;
				size_t Procs12 = AtAProcs / 4;
				size_t Procs21 = AtAProcs / 4;
				size_t Procs22 = AtAProcs - (Procs11 + Procs12 + Procs21);

				SubMatrix A11 = { t.A.M, t.A.BegRow, t.A.BegCol, N2, M2 };
				SubMatrix C11 = { t.C.M, t.C.BegRow, t.C.BegCol, M2, M2 };
				Task st1 = { ATA, A11, A11, C11, Procs11, OtherID };
				QueueEnqueue(&q, &st1);
				TaskTreeAddTaskLevel(&Tree, st1, t.ID, CurLevel);

				SubMatrix A21 = { t.A.M, t.A.BegRow + N2, t.A.BegCol,t.A.NumRows - N2, M2 };
				Task st2 = { ATA, A21, A21, C11, Procs21, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);

				SubMatrix A12 = { t.A.M, t.A.BegRow, t.A.BegCol + M2, N2, t.A.NumCols - M2 };
				SubMatrix C22 = { t.C.M, t.C.BegRow + M2, t.C.BegCol + M2, t.A.NumCols - M2, t.A.NumCols - M2 };
				Task st3 = { ATA, A12, A12, C22, Procs12, ++LastUsed };
				QueueEnqueue(&q, &st3);
				TaskTreeAddTaskLevel(&Tree, st3, t.ID, CurLevel);

				SubMatrix A22 = { t.A.M, t.A.BegRow + N2, t.A.BegCol + M2, t.A.NumRows - N2, t.A.NumCols - M2 };
				Task st4 = { ATA, A22, A22, C22, Procs22, ++LastUsed };
				QueueEnqueue(&q, &st4);
		...
		else
		{
			...
			if (t.Budget == 2)
			{
				...
				Task st2 = { ATB, A, Bx2, Cx2, 1, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
			}
			else if (t.Budget == 3)
			{
				...
				Task st2 = { ATB, Ax1, Bx2, C12, 1, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
				...
				Task st3 = { ATB, Ax2, Bx2, C22, 1, ++LastUsed };
				QueueEnqueue(&q, &st3);
				TaskTreeAddTaskLevel(&Tree, st3, t.ID, CurLevel);
			}
			else if (t.Budget == 4)
			{
				...
				Task st1 = { ATB, Ax1, Bx1, C11, 1, t.ID };
				QueueEnqueue(&q, &st1);
				TaskTreeAddTask(&Tree, st1, t.ID);
				// C21 = A12^T * B11 + A22^T * B21 = Ax2^T * Bx1
				SubMatrix Ax2 = { t.A.M, t.A.BegRow, t.A.BegCol + MA2, t.A.NumRows, t.A.NumCols - MA2 };
				SubMatrix C21 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol, t.A.NumCols - MA2, MB2 };
				Task st2 = { ATB, Ax2, Bx1, C21, 1, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
				// C12 = A11^T * B12 + A21^T * B22 = Ax1^T * Bx2
				SubMatrix Bx2 = { t.B.M, t.B.BegRow, t.B.BegCol + MB2, t.B.NumRows, t.B.NumCols - MB2 };
				SubMatrix C12 = { t.C.M, t.C.BegRow, t.C.BegCol + MB2, MA2, t.B.NumCols - MB2 };
				Task st3 = { ATB, Ax1, Bx2, C12, 1, ++LastUsed };
				QueueEnqueue(&q, &st3);
				TaskTreeAddTaskLevel(&Tree, st3, t.ID, CurLevel);
				// C22 = A12^T * B12 + A22^T * B22 = Ax2^T * Bx2
				SubMatrix C22 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol + MB2, t.A.NumCols - MA2, t.B.NumCols - MB2 };
				Task st4 = { ATB, Ax2, Bx2, C22, 1, ++LastUsed };
				QueueEnqueue(&q, &st4);
				TaskTreeAddTaskLevel(&Tree, st4, t.ID, CurLevel);
			}
			else if (t.Budget == 5)
			{
				// first step: 	C11 = A11^T * B11
				SubMatrix A11 = { t.A.M, t.A.BegRow, t.A.BegCol, NA2, MA2 };
				SubMatrix B11 = { t.B.M, t.B.BegRow, t.B.BegCol, NB2, MB2 };
				SubMatrix C11 = { t.C.M, t.C.BegRow, t.C.BegCol, MA2, MB2 };
				Task st1 = { ATB, A11, B11, C11, 1, t.ID };
				QueueEnqueue(&q, &st1);
				TaskTreeAddTask(&Tree, st1, t.ID);
				// second step: C11 = A21^T * B21
				SubMatrix A21 = { t.A.M, t.A.BegRow + NA2, t.A.BegCol, t.A.NumRows - NA2, MA2 };
				SubMatrix B21 = { t.B.M, t.B.BegRow + NB2, t.B.BegCol, t.B.NumRows - NB2, MB2 };
				Task st2 = { ATB, A21, B21, C11, 1, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
				// C21 = A12^T * B11 + A22^T * B21 = Ax2^T * Bx1
				SubMatrix Ax2 = { t.A.M, t.A.BegRow, t.A.BegCol + MA2, t.A.NumRows, t.A.NumCols - MA2 };
				SubMatrix Bx1 = { t.B.M, t.B.BegRow, t.B.BegCol, t.B.NumRows, MB2 };
				SubMatrix C21 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol, t.A.NumCols - MA2, MB2 };
				Task st3 = { ATB, Ax2, Bx1, C21, 1, ++LastUsed };
				QueueEnqueue(&q, &st3);
				TaskTreeAddTaskLevel(&Tree, st3, t.ID, CurLevel);
				// C12 = A11^T * B12 + A21^T * B22 = Ax1^T * Bx2
				SubMatrix Ax1 = { t.A.M, t.A.BegRow, t.A.BegCol, t.A.NumRows, MA2 };
				SubMatrix Bx2 = { t.B.M, t.B.BegRow, t.B.BegCol + MB2, t.B.NumRows, t.B.NumCols - MB2 };
				SubMatrix C12 = { t.C.M, t.C.BegRow, t.C.BegCol + MB2, MA2, t.B.NumCols - MB2 };
				Task st4 = { ATB, Ax1, Bx2, C12, 1, ++LastUsed };
				QueueEnqueue(&q, &st4);
				TaskTreeAddTaskLevel(&Tree, st4, t.ID, CurLevel);
				// C22 = A12^T * B12 + A22^T * B22 = Ax2^T * Bx2
				SubMatrix C22 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol + MB2, t.A.NumCols - MA2, t.B.NumCols - MB2 };
				Task st5 = { ATB, Ax2, Bx2, C22, 1, ++LastUsed };
				QueueEnqueue(&q, &st5);
				TaskTreeAddTaskLevel(&Tree, st5, t.ID, CurLevel);
			}
			else if (t.Budget == 6)
			{
				// first step: 	C11 = A11^T * B11
				...
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
				// first step: 	C21 = A12^T * B11
				SubMatrix A12 = { t.A.M, t.A.BegRow, t.A.BegCol + MA2, NA2, t.A.NumCols - MA2 };
				SubMatrix C21 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol, t.A.NumCols - MA2, MB2 };
				Task st3 = { ATB, A12, B11, C21, 1, ++LastUsed };
				QueueEnqueue(&q, &st3);
				TaskTreeAddTaskLevel(&Tree, st3, t.ID, CurLevel);
				// second step: C21 = A22^T * B21
				SubMatrix A22 = { t.A.M, t.A.BegRow + NA2, t.A.BegCol + MA2, t.A.NumRows - NA2, t.A.NumCols - MA2 };
				Task st4 = { ATB, A22, B21, C21, 1, ++LastUsed };
				QueueEnqueue(&q, &st4);
				TaskTreeAddTaskLevel(&Tree, st4, t.ID, CurLevel);
				// C12 = A11^T * B12 + A21^T * B22 = Ax1^T * Bx2
				SubMatrix Ax1 = { t.A.M, t.A.BegRow, t.A.BegCol, t.A.NumRows, MA2 };
				SubMatrix Bx2 = { t.B.M, t.B.BegRow, t.B.BegCol + MB2, t.B.NumRows, t.B.NumCols - MB2 };
				SubMatrix C12 = { t.C.M, t.C.BegRow, t.C.BegCol + MB2, MA2, t.B.NumCols - MB2 };
				Task st5 = { ATB, Ax1, Bx2, C12, 1, ++LastUsed };
				QueueEnqueue(&q, &st5);
				TaskTreeAddTaskLevel(&Tree, st5, t.ID, CurLevel);
				// C22 = A12^T * B12 + A22^T * B22 = Ax2^T * Bx2
				SubMatrix Ax2 = { t.A.M, t.A.BegRow, t.A.BegCol + MA2, t.A.NumRows, t.A.NumCols - MA2 };
				SubMatrix C22 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol + MB2, t.A.NumCols - MA2, t.B.NumCols - MB2 };
				Task st6 = { ATB, Ax2, Bx2, C22, 1, ++LastUsed };
				QueueEnqueue(&q, &st6);
				TaskTreeAddTaskLevel(&Tree, st6, t.ID, CurLevel);
			}
			else if (t.Budget == 7)
			{
				// first step: 	C11 = A11^T * B11
				...
				QueueEnqueue(&q, &st4);
				TaskTreeAddTaskLevel(&Tree, st4, t.ID, CurLevel);
				// first step: 	C12 = A11^T * B12
				SubMatrix B12 = { t.B.M, t.B.BegRow, t.B.BegCol + MB2, NB2, t.B.NumCols - MB2 };
				SubMatrix C12 = { t.C.M, t.C.BegRow, t.C.BegCol + MB2, MA2, t.B.NumCols - MB2 };
				Task st5 = { ATB, A11, B12, C12, 1, ++LastUsed };
				QueueEnqueue(&q, &st5);
				TaskTreeAddTaskLevel(&Tree, st5, t.ID, CurLevel);
				// second step: C12 = A21^T * B22
				SubMatrix B22 = { t.B.M, t.B.BegRow + NB2, t.B.BegCol + MB2, t.B.NumRows - NB2, t.B.NumCols - MB2 };
				Task st6 = { ATB, A21, B22, C12, 1, ++LastUsed };
				QueueEnqueue(&q, &st6);
				TaskTreeAddTaskLevel(&Tree, st6, t.ID, CurLevel);
				// C22 = A12^T * B12 + A22^T * B22 = Ax2^T * Bx2
				SubMatrix Ax2 = { t.A.M, t.A.BegRow, t.A.BegCol + MA2, t.A.NumRows, t.A.NumCols - MA2 };
				SubMatrix Bx2 = { t.B.M, t.B.BegRow, t.B.BegCol + MB2, t.B.NumRows, t.B.NumCols - MB2 };
				SubMatrix C22 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol + MB2, t.A.NumCols - MA2, t.B.NumCols - MB2 };
				Task st7 = { ATB, Ax2, Bx2, C22, 1, ++LastUsed };
				QueueEnqueue(&q, &st7);
				TaskTreeAddTaskLevel(&Tree, st7, t.ID, CurLevel);
			}
			else
			{
				// first step: 	C11 = A11^T * B11
				...
				SubMatrix B11 = { t.B.M, t.B.BegRow, t.B.BegCol, NB2, MB2 };
				SubMatrix C11 = { t.C.M, t.C.BegRow, t.C.BegCol, MA2, MB2 };
				Task st1 = { ATB, A11, B11, C11, t.Budget / 8, t.ID };
				QueueEnqueue(&q, &st1);
				TaskTreeAddTask(&Tree, st1, t.ID);
				// second step: C11 = A21^T * B21
				SubMatrix A21 = { t.A.M, t.A.BegRow + NA2, t.A.BegCol, t.A.NumRows - NA2, MA2 };
				SubMatrix B21 = { t.B.M, t.B.BegRow + NB2, t.B.BegCol, t.B.NumRows - NB2, MB2 };
				Task st2 = { ATB, A21, B21, C11, t.Budget / 8, ++LastUsed };
				QueueEnqueue(&q, &st2);
				TaskTreeAddTaskLevel(&Tree, st2, t.ID, CurLevel);
				// first step: 	C21 = A12^T * B11
				SubMatrix A12 = { t.A.M, t.A.BegRow, t.A.BegCol + MA2, NA2, t.A.NumCols - MA2 };
				SubMatrix C21 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol, t.A.NumCols - MA2, MB2 };
				Task st3 = { ATB, A12, B11, C21, t.Budget / 8, ++LastUsed };
				QueueEnqueue(&q, &st3);
				TaskTreeAddTaskLevel(&Tree, st3, t.ID, CurLevel);
				// second step: C21 = A22^T * B21
				SubMatrix A22 = { t.A.M, t.A.BegRow + NA2, t.A.BegCol + MA2, t.A.NumRows - NA2, t.A.NumCols - MA2 };
				Task st4 = { ATB, A22, B21, C21, t.Budget / 8, ++LastUsed };
				QueueEnqueue(&q, &st4);
				TaskTreeAddTaskLevel(&Tree, st4, t.ID, CurLevel);
				// first step: 	C12 = A11^T * B12
				SubMatrix B12 = { t.B.M, t.B.BegRow, t.B.BegCol + MB2, NB2, t.B.NumCols - MB2 };
				SubMatrix C12 = { t.C.M, t.C.BegRow, t.C.BegCol + MB2, MA2, t.B.NumCols - MB2 };
				Task st5 = { ATB, A11, B12, C12, t.Budget / 8, ++LastUsed };
				QueueEnqueue(&q, &st5);
				TaskTreeAddTaskLevel(&Tree, st5, t.ID, CurLevel);
				// second step: C12 = A21^T * B22
				SubMatrix B22 = { t.B.M, t.B.BegRow + NB2, t.B.BegCol + MB2, t.B.NumRows - NB2, t.B.NumCols - MB2 };
				Task st6 = { ATB, A21, B22, C12, t.Budget / 8, ++LastUsed };
				QueueEnqueue(&q, &st6);
				TaskTreeAddTaskLevel(&Tree, st6, t.ID, CurLevel);
				// first step: 	C22 = A12^T * B12
				SubMatrix C22 = { t.C.M, t.C.BegRow + MA2, t.C.BegCol + MB2, t.A.NumCols - MA2, t.B.NumCols - MB2 };
				Task st7 = { ATB, A12, B12, C22, t.Budget / 8, ++LastUsed };
				QueueEnqueue(&q, &st7);
				TaskTreeAddTaskLevel(&Tree, st7, t.ID, CurLevel);
				// second step: C22 = A22^T * B22
				Task st8 = { ATB, A22, B22, C22, t.Budget - 7 * (t.Budget / 8), ++LastUsed };
				QueueEnqueue(&q, &st8);
				TaskTreeAddTaskLevel(&Tree, st8, t.ID, CurLevel);
			}
		}
	}
